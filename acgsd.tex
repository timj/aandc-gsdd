...
single ASCII table were file, was not deemed an
...
represented on disk.  The format was described in both a JCMT
technical note and an NRAO Newsletter article, but a formal definition
of the format was not published in the literature. In this article we
present the first description of the model and provide a retrospective
