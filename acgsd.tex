...
community such as KAPPA \citep[][\ascl{1403.022}]{SUN95}.
...
item names to the newer NDF-based raw data models.
...
format \citep{OCS_ICD_022} such that they can be reduced using the
