...
{\color{red}
  ...
  SDD format (Fig.~\ref{fig:nraosdd}) in that UNIPOPS document seems slightly different to the
  JCMT implementation. It also evolved by changing the integer data
  type. SDD uses the same Class names from GSDD.

  How does PDFL compare to SDD?
