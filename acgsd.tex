...
not realize that there was a standard and therefore there was no
...
A major blessing of GSDD is that the standard actually allowed sites
...
GSDD reader could still manage the files.  Such rules as: don't touch
the pre-defined keywords (which were to have predefined byte sizes and
were always to be in a certain order at the start of a class), you're
...
telescope, hack away at class 10 in any way you want, and be sure to
