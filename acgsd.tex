...
\tnotetext[ascl]{These codes are registered at the
Astrophysics Source Code Library (ASCL) with the code entries
\ascl{1503.009} and \ascl{1503.007}.}
...
% RMP
%
\textcolor{red}{I'm not sure what the following sentence means. NRAO and
JCMT {\bf did} tackle a global standard for raw data, they just didn't
succeed in the implementation. Also, is the sentence referring to
NRAO and JCMT specifically, or observatories in general?}
It
